...
//mechanized infantry
public class LMGTeam : Unit {
    public SoldierAnimator soldier1, soldier2, soldier3;
    public Transform truck;
    public Sprite sovietTruck, americanTruck, japaneseTruck, frenchTruck, britishTruck;
    ...
    public override void updateSkin() {
        ...
        if (troopSkin == Skin.Soviet) {
            truck.GetComponent<SpriteRenderer>().sprite = sovietTruck;
        } else if (troopSkin == Skin.American) {
            truck.GetComponent<SpriteRenderer>().sprite = americanTruck;
        } else if (troopSkin == Skin.Japanese) {
            truck.GetComponent<SpriteRenderer>().sprite = japaneseTruck;

        } else if (troopSkin == Skin.British) {
            truck.GetComponent<SpriteRenderer>().sprite = britishTruck;

        } else if (troopSkin == Skin.French) {
            truck.GetComponent<SpriteRenderer>().sprite = frenchTruck;
        ...
        if (troopSkin == Skin.Soviet) {
            ...
            soldier3.gun.GetComponent<SpriteRenderer>().sprite = manager.sovietLMG;
            ...
            soldier3.gun.GetComponent<SpriteRenderer>().sprite = manager.americanLMG;
