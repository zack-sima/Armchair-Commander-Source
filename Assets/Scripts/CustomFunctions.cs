...
public static class CustomFunctions {
	...
	public static string getURL() {
		return "http://main.indiewargames.net:8080/";
	}
	public static Sprite LoadSpriteFromBytes(byte[] bytes) {
		Texture2D texture = new(1, 1);
		texture.LoadImage(bytes);
		Sprite s = Sprite.Create(texture, new Rect(0, 0, texture.width, texture.height), Vector2.one / 2f);


		return s;
	}
	public static List<string> CountriesIsNeutral = new() {
		"Portugal",
		"NeutralSpain",
		"Switzerland",
		"Sweden",
